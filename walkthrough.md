...
1. Up (0,2) → gravity DOWN → (0,3)
2. Up (0,2) → gravity UP → (0,0)
3. Right (1,0) → gravity LEFT → (0,0) 
...
- Move 1: ⬇️, Move 2: ⬆️, Move 3: ⬅️, Move 4: ➡️, repeat...
...
### 10. HAVE FUN
You're a cute marshmallow in space. Enjoy the ride! 🍥🌙
